...
if (url) {
  ...
  page.customHeaders = {};
  var credentialObj = {};
  var credentialPairs = credentials.split('||');
  for(var i = 0; i < credentialPairs.length; i++){
    var credentialPair = credentialPairs[i].split('::');
    credentialObj['Authorization--' + credentialPair[0]] = credentialPair[1];
  }
  page.customHeaders = credentialObj;
