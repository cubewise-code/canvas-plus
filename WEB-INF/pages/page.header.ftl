...
<div   
    ...
    style="vertical-align: bottom !important; position:fixed; top:0px; left:0px; width:100%;  z-index:5; padding-top:50px; background-color:#06368b;">  
        ...
        <ul class="navbuttons" style="vertical-align: bottom !important; margin:0px; background-color:#06368b;" >
            <li ng-click="$root.activeTab = -1;  "   id="home-nav-btn" ng-class="!$root.activeTab || $root.activeTab === -1  ? 'active':''">
                <span> 
                    <a href="#" data-toggle="tab"  > 
                        <i ng-if="!$root.activeTab || $root.activeTab === -1" class="fa fa-home fa-1x"></i> 
                        <i ng-if="$root.activeTab && $root.activeTab != -1" 
                        class="fa fa-caret-left fa-1x"></i>  {{$root.pathToUse != '' && $root.activeTab &&  $root.activeTab != -1 ? 'Home' : ''}}
                    </a> 
                </span>
            </li>
            <li   
